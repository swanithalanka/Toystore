...
import Toy_1 from '../Assets/arrival-1.webp';
import Toy_2 from '../Assets/arrival-2.webp';
import Toy_3 from '../Assets/arrival-3.jpg';
import Toy_4 from '../Assets/arrival-4.webp';
import Toy_5 from '../Assets/arrival-5.webp';
import Toy_6 from '../Assets/arrival-6.webp';
import Toy_7 from '../Assets/arrival-7.webp';
...
const Toys = () => {
  ...
  return (
    <div className="bg-blue-200 mt-8 mb-16 py-8">
      <h2 className="text-3xl text-center font-bold mb-4">The Joys of Toys</h2>
      <Slider {...settings}>
        {cards.map((card) => (
